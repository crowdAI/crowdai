...
RSpec.describe "email_preferences/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit email_preference form" do
    render

    assert_select "form[action=?][method=?]", email_preference_path(@email_preference), "post" do
