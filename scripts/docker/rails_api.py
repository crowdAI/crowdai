...
class RailsAPI(object):
  ...
  def call_endpoint(self,payload):
    ...
    # curl -X PUT -G http://localhost:3000/api/v1/submissions/24 -d "score=999999" -d "score_secondary=123456" -H 'Authorization: Token token="REDACTED"'
  ...
  curl -X PUT -G https://www.crowdai.org/api/v1/submissions/20004 -d "score=999999" -d "score_secondary=123456" -H 'Authorization: Token token="REDACTED"'
