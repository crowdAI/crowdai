...
ActiveRecord::Schema.define(version: 20160517145052) do
  ...
  create_table "challenges", force: :cascade do |t|
    ...
    t.text     "rules_rendered"
    t.text     "prizes_markdown"
    t.text     "prizes_rendered"
    t.text     "resources_markdown"
    t.text     "resources_rendered"
    t.text     "dataset_description_markdown"
    t.text     "dataset_description_rendered"
    t.text     "submission_instructions_markdown"
    t.text     "submission_instructions_rendered"
  end
